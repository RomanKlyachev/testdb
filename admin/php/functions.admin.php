        ...
        private function getTableColArray() {
            ...
            switch ($this->dbName) {
                ...
                case "NL_MATERIAL":
                    ...
                    break;
                case "NL_PROP_RESALE":
                    $colNames = ["NL_PROP_RESALE_AREA_FULL", "ID_NL_HOUSES",  "NL_PROP_RESALE_ADDRESS", "ID_NL_MATERIAL", "NL_PROP_RESALE_FLOOR", "NL_PROP_RESALE_COST_TOTAL", "NL_PROP_RESALE_PHONE_OWNER", "ID_NL_VIEW", "ID_NL_USER", "NL_PROP_RESALE_PHONE", "NL_PROP_RESALE_PHOTO_URLS", "NL_PROP_RESALE_DESCRIPTION"];
                    $table = $this->getTableColArrayByColumnNames($tableName, $colNames);
                    break;
            }
        ...
        public function getData($page = 0, $limit = 0, $sidx = "1", $sord = "ASC", $search_where = "(1 = 1)") {
            ...
            //} else {
                ...
                for ($i = 1; $i < (count($this->colArray) / 2); $i++) {
                    /* @var $col ObjectParam */
                    $col = !empty($this->colArray[$i]) ? $this->colArray[$i] : "0";
